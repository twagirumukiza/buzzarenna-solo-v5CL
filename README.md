...
## V5.1 — Mode Entraînement (solo)

- Un nouveau panneau **« 🎯 Mode Entraînement »** apparaît sur la page d'accueil, sous les panneaux Créer/Rejoindre un salon.
- Fonctionne entièrement **sans salon ni connexion Firebase** : un seul joueur répond seul à des questions tirées de la banque, à son propre rythme.
- Réglable exactement comme une partie à plusieurs : thèmes multiples cochables, temps par question (10 à 120 s), nombre de questions (5 à 30).
- Reprend l'ambiance du jeu : présentateur TV (annonces, questions doubles/triples), confettis et bilan personnalisé en fin de session (bonnes réponses, temps moyen, badges 🔥 ⚡ 🎯), avec le même bouton **📊 Statistiques**.
- Deux boutons discrets 🛑/🔄 en haut à gauche permettent de terminer l'entraînement en avance (avec bilan immédiat) ou de le recommencer depuis le début avec les mêmes réglages.
- Boutons de fin adaptés : **🔁 Rejouer** relance un nouvel entraînement avec les mêmes réglages, **🚪 Quitter** retourne à l'accueil.
